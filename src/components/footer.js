      ...
      <footer className="text-center text-surface/75bg-blue-950 border-gray-200 text-white lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
          <div className="me-12 hidden lg:block">
            ...
            {/* <span>L'Alpine c'est de la bagnole </span> */}
          </div>
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="">
              <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start text-xl">
                {" "}
                L'Alpine ça c'est de la bagnole !
            ...
            <div>
              ...
              <p className="mb-4">
                <a href="#!">Alpine A110</a>
              </p>
              <p className="mb-4">
                <a href="#!">Alpine A220</a>
              </p>
              <p className="mb-4">
                <a href="#!">Alpine A4</a>
              </p>
